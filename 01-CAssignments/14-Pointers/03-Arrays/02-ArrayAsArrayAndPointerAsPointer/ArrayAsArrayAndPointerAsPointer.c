...
int main(void)
{
	...
	// ###### USING ARRAY NAME AS AN ARRAY i.e Value Of xth Element Of iArray_mk: iArray_mk[x] AND Address Of xth Element Of iArray_mk: &iArray_mk[x] ######
	printf("\n\n");
	printf("*** USING ARRAY NAME AS AN ARRAY i.e Value of xth Element Of iArray_mk: iArray_mk[x] AND Address Of xth Element Of iArray_mk: &iArray_mk[x] ***\n\n");
	...
	// ###### USING POINTER AS POINTER i.e Value of xth Element Of iArray_mk: *(ptr_iArray_mk + x) AND Address Of xth Element Of iArray_mk (ptr_iArray_mk + x) ######
	printf("\n\n");
	printf("*** USING POINTER AS POINTER i.e Value of xth Element Of iArray_mk: *(ptr_iArray_mk + x) AND Address Of xth Element Of iArray_mk (ptr_iArray_mk + x) ***\n\n");
	printf("Integer Array Elements And Their Addresses: \n\n");
