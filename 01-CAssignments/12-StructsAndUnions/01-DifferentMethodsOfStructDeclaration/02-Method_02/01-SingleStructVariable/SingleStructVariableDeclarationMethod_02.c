...
struct MyPoint_mk
{
	int x_mk;
	int y_mk;
} point_mk; //declaraing a single variable of type 'struct MyPoint_mk' globally...

//DEFINING STRUCT
struct MyPointProperties_mk
{
	int quadrant_mk;
	char axis_location_mk[10]; // Fixed: Restored [10] string buffer dimension
} point_properties_mk; //declaraing a single variable of type 'struct MyPointProperties_mk' globally...
