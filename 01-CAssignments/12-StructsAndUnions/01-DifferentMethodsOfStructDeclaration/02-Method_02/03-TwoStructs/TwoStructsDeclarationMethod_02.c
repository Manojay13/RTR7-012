...
struct MyPoint_mk point_mk; //declaraing a single variable of type 'struct MyPoint_mk' globally...
struct MyPointProperties_mk point_properties_mk; //declaraing a single variable of type 'struct MyPointProperties_mk' globally...
