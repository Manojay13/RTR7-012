...
int main(void)
{
	...
	struct MyPoint_mk point_mk; //declaring a single variable of type 'struct MyPoint_mk' locally...
	struct MyPointProperties_mk point_properties_mk; //declaring a single variable of type 'struct MyPointProperties_mk' locally...
